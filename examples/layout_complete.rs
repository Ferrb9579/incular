    ...
    let app = Application::new(move |_| {
        ScrollView::vertical(scroll.clone(), Padding::all(16., Column::new(vec![
            ...
            panel(Column::new(vec![
                ...
                LimitedBox::new(360., 48., tile(Size::new(480., 96.), Color::rgba(60, 144, 199, 255))).into(),
                label("OverflowBox reports available width while its child paints wider"),
                SizedBox::new(Size::new(300., 48.), OverflowBox::new(tile(Size::new(460., 42.), Color::rgba(168, 80, 166, 255))).min_width(460.).max_width(460.)).into(),
            ])),
            panel(Column::new(vec![
                label("Expanded + Flexible + Spacer in a bounded row"),
                SizedBox::new(Size::new(360., 58.), Row::new(vec![
                    Expanded::new(tile(Size::new(40., 42.), Color::rgba(56, 157, 126, 255))).flex(2).into(),
                    Flexible::new(1, tile(Size::new(70., 42.), Color::rgba(218, 147, 64, 255))).into(),
            ...
            panel(Column::new(vec![
                ...
                SizedBox::new(Size::new(360., 138.), Stack::aligned(Alignment::CENTER, vec![
            ...
            panel(Column::new(vec![
                ...
                SizedBox::new(Size::new(360., 115.), FittedBox::new(Transform::rotation(-0.12, tile(Size::new(220., 60.), Color::rgba(81, 169, 137, 255)))).fit(ImageFit::Contain).alignment(Alignment::CENTER)).into(),
            ])),

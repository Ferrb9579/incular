...
/// entries, not bytes. Each object retains font bytes and parsed tables;
/// glyph outlines are decoded transiently on atlas misses. The limit
/// bounds object count only. Eviction drops the parsed object

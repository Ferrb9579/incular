...
## Display-list and compositor contract

`incular-rendering` owns compact ordered `DisplayList` and `PaintCommand` values. It depends on
...
`LayerTree` stores stable generational `Picture`, `Transform`, and

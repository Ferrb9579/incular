...
fn native_application_shell_smoke() {
    ...
    let _tray = shell
        ...
        .expect("queue native StatusNotifierItem creation");
    ...
    incular_linux::run_application(application).expect("desktop event loop");
    ...
    assert!(
        ...
        "native StatusNotifierItem creation failed: {:?}",
